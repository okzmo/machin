...
func (c *greeterClient) SayManyHellos(ctx context.Context, in *flatbuffers.Builder,
	opts ...grpc.CallOption) (Greeter_SayManyHellosClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Greeter_serviceDesc.Streams[0], "/Greeter.Greeter/SayManyHellos", opts...)
	if err != nil {
		return nil, err
	}
...
type GreeterServer interface {
	...
	SayManyHellos(*ManyHellosRequest, Greeter_SayManyHellosServer) error
...
func (UnimplementedGreeterServer) SayManyHellos(*ManyHellosRequest, Greeter_SayManyHellosServer) error {
